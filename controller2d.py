...
class Controller2D(object):
    ...
    def update_controls(self):
        ...
        if self._start_control_loop:
            ...
            derive =  (delta_v - self.vars.prev_error) / dt
            self.prev_error = delta_v
            
            integral = self.vars.int_value + delta_v * t
            
            
            
            pid = kp * delta_v + ki * integral + kd * derive 
            ...
            steer_expect = np.arctan((2 * L * np.sin(alpha) )/(K_dd * v))
